...
{
    std::cout << "ChatBotPanelDialog Constructor: Object Instance: "<<this<< std::endl;
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    std::cout << "ChatBotPanelDialog Destructor: Object Instance: "<<this<< std::endl;      
}
...
{
    std::cout << "ChatBotPanelDialogItem is created" << std::endl;
